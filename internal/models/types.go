...
// Bus/class start as device-path inferences and may be refined from sysfs.
// Kind is "local" or "network". Role is "root" or "other".
// Owner/OwnerMount join a network Device to a cluster node after collect.
type Volume struct {
	...
	Bus        string `json:"bus,omitempty" yaml:"bus,omitempty"`     // nvme, usb, sata, mmc, cifs, nfs, unknown
	Class      string `json:"class,omitempty" yaml:"class,omitempty"` // nvme, ssd, hdd, network, unknown
	...
	Removable  bool   `json:"removable,omitempty" yaml:"removable,omitempty"`
	LinkMbit   int64  `json:"link_mbit,omitempty" yaml:"link_mbit,omitempty"`
}
