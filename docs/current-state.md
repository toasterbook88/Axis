...
- Refreshed: 2026-06-18 EDT
- Repo version: `0.12.0`
- Latest published GitHub release: `v0.12.0` (2026-06-17T21:00:12Z)
...
- `./hack/coverage-check.sh` -> passes
  - Coverage gates:
    ...
    - `coverage gate passed: internal/ui 93.1% >= 80.0%`
    - `coverage gate passed: total 69.7% >= 45.0%`
